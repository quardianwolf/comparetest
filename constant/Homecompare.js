      ...
      <div className='hom_compare'>
        <div className='main_table main_table_hori'>
          <div className='text_box'>
            <div className='prose'>
              <p className='bold'>Compare</p>
              <h2 className='h2'>Which wireless headphones are made for you?</h2>
              <p className='text_lon'>Not sure which one to choose? We selected our most popular wireless headphones. Compare them and choose the best version for your needs.</p>
              <a className='button button--lg' href='/'>Learn more</a>
            </div>
          </div>
          <div className='tablo'>
